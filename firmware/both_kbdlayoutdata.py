...
LEFT_KEY_GROUPS = [
    ...
    {
        LI2U: [LEFT_INDEX2_UP],
        LI2M: [LEFT_INDEX2_UP, LEFT_INDEX2_DOWN],
        LI2D: [LEFT_INDEX2_DOWN],
    },
    {
        LTU: [LEFT_THUMB_UP],
...
RIGHT_KEY_GROUPS = [
    ...
    {
        RI2U: [RIGHT_INDEX2_UP],
        RI2M: [RIGHT_INDEX2_UP, RIGHT_INDEX2_DOWN],
        RI2D: [RIGHT_INDEX2_DOWN],
    },
    {
        RI1U: [RIGHT_INDEX_UP],
...
MODIFIERS = {
    LI1U: ('LShift', NO_KEY, LTD, LTM, RTM, RTD),
    LMU:  ('LCtrl',  NO_KEY, LTD, LTM, RTM, RTD),
    LRU:  ('LAlt',   NO_KEY, LTD, LTM, RTM, RTD),
    LPU:  ('LGui',   NO_KEY, LTD, LTM, RTM, RTD),
